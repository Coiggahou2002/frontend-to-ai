...
| 型号 | 显存 | FP16 算力 | 定位 |
|------|------|-----------|------|
| T4 | 16 GB | 65 TFLOPS | 成本最优推理（老云平台存量机型） |
| V100 | 16 / 32 GB | 112 TFLOPS | 训练（上上代，历史存量多） |
| L4 | 24 GB | 121 TFLOPS | 性价比推理，极低功耗（72 W） |
| RTX 4090 | 24 GB | 165 TFLOPS | 消费级，个人开发 / 小规模微调 |
| L20 | 48 GB | ~181 TFLOPS | 推理，显存比 L4 大一倍 |
| A100 | 40 / 80 GB | 312 TFLOPS | 训练 + 推理（上一代旗舰） |
| H100 | 80 GB | 989 TFLOPS | 当前训练旗舰 |
| H200 | 141 GB | 989 TFLOPS | H100 算力 + HBM3e 大显存，推理优先 |
| B200 | 192 GB | ~2,250 TFLOPS | Blackwell 旗舰，下一代训练标配 |
| B300 | 288 GB | > 4,000 TFLOPS | Blackwell Ultra，极端规模训练 |
